:root{
    --borderImportant: #35383f !important;
    --foregroundDefault: #e2e3e7 !important;
}
.banner-bottom__close:before,
.breadcrumbs__item_home .breadcrumbs__link:before,
.buy-discount__discount-label:after,
.buy-discount_open .buy-discount__discount-label:after,
.close-button:after,
...
.comments__header-title a:before,
.course-feedback__add-comment:after,
.course-feedback_not-public:after,
.course-list-item__info-header:before,
...
.main [with-zone]:after,
.main__anchor:before,
.main__footer-star:before,
.map:before,
.mdeditor__button[data-action=autolink]:before,
.mdeditor__button[data-action=bold]:before,
.mdeditor__button[data-action=code]:before,
.mdeditor__button[data-action=cut]:before,
.mdeditor__button[data-action=fencedCode]:before,
.mdeditor__button[data-action=heading]:before,
.mdeditor__button[data-action=image]:before,
.mdeditor__button[data-action=italic]:before,
.mdeditor__button[data-action=link]:before,
.mdeditor__button[data-action=ol]:before,
.mdeditor__button[data-action=quote]:before,
.mdeditor__button[data-action=redo]:before,
.mdeditor__button[data-action=ul]:before,
.mdeditor__button[data-action=undo]:before,
.multiselect__active-button:after,
.multiselect_opened .multiselect__active-button:after,
.newsletter-release-edit__button-preview:after,
.newsletter-release-edit__preview-link:after,
.newsletter-release-edit__remove:after,
...
.sitetoolbar__lang-switcher .sitetoolbar__dropdown-button:before,
...
.subscribe__toggle-link:after,
.subscribe_opened .subscribe__toggle-link:after,
.tablet-ebook:before,
...
.text-input.text-input_discount:after,
...
.no-icons .buy-discount__discount-label:after,
.no-icons .buy-discount_open .buy-discount__discount-label:after,
...
.no-icons .comments__header-title a:before,
.no-icons .course-feedback__add-comment:after,
.no-icons .course-feedback_not-public:after,
.no-icons .course-list-item__info-header:before,
...
.no-icons .main [with-zone]:after,
.no-icons .main__anchor:before,
.no-icons .main__footer-star:before,
.no-icons .map:before,
.no-icons .mdeditor__button[data-action=autolink]:before,
.no-icons .mdeditor__button[data-action=bold]:before,
.no-icons .mdeditor__button[data-action=code]:before,
.no-icons .mdeditor__button[data-action=cut]:before,
.no-icons .mdeditor__button[data-action=fencedCode]:before,
.no-icons .mdeditor__button[data-action=heading]:before,
.no-icons .mdeditor__button[data-action=image]:before,
.no-icons .mdeditor__button[data-action=italic]:before,
.no-icons .mdeditor__button[data-action=link]:before,
.no-icons .mdeditor__button[data-action=ol]:before,
.no-icons .mdeditor__button[data-action=quote]:before,
.no-icons .mdeditor__button[data-action=redo]:before,
.no-icons .mdeditor__button[data-action=ul]:before,
.no-icons .mdeditor__button[data-action=undo]:before,
.no-icons .multiselect__active-button:after,
.no-icons .multiselect_opened .multiselect__active-button:after,
.no-icons .newsletter-release-edit__button-preview:after,
.no-icons .newsletter-release-edit__preview-link:after,
.no-icons .newsletter-release-edit__remove:after,
...
.no-icons .sitetoolbar__lang-switcher .sitetoolbar__dropdown-button:before,
...
.no-icons .slider__arrow_left:after,
.no-icons .slider__arrow_right:after,
.no-icons .social-login_discord:before,
...
.no-icons .subscribe__toggle-link:after,
.no-icons .subscribe_opened .subscribe__toggle-link:after,
...
.no-icons .text-input.text-input_discount:after,
...
.no-icons .updated-at__content:before,
...
.complex-form .complex-form__step,
.course-feedback,
...
.share-icons__im::-moz-focus-inner,
...
.working-hover .share-icons__im:hover,
...
a[href*="_[stub]_"] {
    color: var(--foregroundInverted) !important
}
...
.formatted code.pattern {
    border-bottom: 1px solid var(--borderAccent)
}

.formatted code.subject {
...
.formatted span.shortcut {
    white-space: nowrap
}

.formatted span.shortcut code {
...
.formatted table tr:nth-child(2n) {
...
.formatted table tr:first-child th {
...
.tasks-filter__option:first-child {
    margin-right: 30px
}
...
.banner-bottom {
    ...
    padding-left: 150px;
    padding-right: 24px;
    background: url(/pack/modules/styles/blocks/banner-bottom/banner-courses.62c48653b7e0dbbe06616e14e4e47f91.svg) 10px no-repeat var(--backgroundAlt)
}
...
.buy-option h3.buy-option__option-title,
.buy-option h4.buy-option__option-subtitle,
.buy-option li.buy-option__option,
.buy-option ul.buy-option__options {
    margin: 0;
    padding: 0
}

.buy-option li.buy-option__option:before {
    display: none;
    content: ""
}
...
.buy-option__option-label .course-register-settings {
    margin-top: 0;
    width: auto
}

.buy-option__option-label .number-input__btn {
    background-color: #fd9460
}

.buy-option__option-label .number-input__btn:disabled {
...
.buy-option__option-radio:checked~.buy-option__option-label {
    background-color: #feeee0
}

.buy-option__option-radio:not(:checked)~.buy-option__option-label .course-register-settings {
    display: none
}

.buy-option__option-radio:checked~.buy-option__option-label .option-setting {
    display: block
}
...
.carbon-ad #_default_ {
    position: relative;
    padding: 14px 20px;
    background: repeating-linear-gradient(-45deg, transparent, transparent 5px, rgba(0, 0, 0, .018) 0, rgba(0, 0, 0, .018) 10px) #f6f2f0;
    font-size: 14px;
    line-height: 1.5
}

.carbon-ad #_default_:after {
    position: absolute;
    bottom: 0;
    left: 0;
    overflow: hidden;
    width: 100%;
    border-bottom: 4px solid #be1722;
    content: "";
...
.working-hover .carbon-ad #_default_:hover:after {
    -webkit-transform: scaleX(1);
    transform: scaleX(1)
}

.carbon-ad .default-ad {
    display: none
}
...
.working-hover .carbon-ad a:hover {
    color: inherit;
    text-decoration: none !important
}

.carbon-ad .default-image {
    display: none
}

.carbon-ad .default-description,
.carbon-ad .default-title {
    display: inline;
    line-height: 1
}
...
.carbon-ad .default-title:before {
    position: absolute;
    top: -25px;
    padding: 4px 6px;
    border-radius: 2px;
...
.codebox.code-example__codebox,
.codebox.code-example__codebox pre[class*=language-] {
    margin-bottom: 0
}
...
.code-example .code-example__result {
    margin-top: 0
}
...
.code-tabs__dropdown {
    background: var(--backgroundBase);
    font-size: 14px;
    border: solid var(--borderPrimary);
...
.codebox__output-line:before {
    content: ">";
    font-weight: 700;
    color: var(--foregroundCalloutAlt);
    margin-right: 8px
}

.codebox__output-label {
    font-family: Consolas, Lucida Console, Menlo, Monaco, monospace;
    position: absolute;
    top: 16px;
    right: 16px;
...
.page_ebook .codebox,
.page_ebook .codebox__code {
    height: auto
}

.page_ebook .codebox__output {
    background: var(--backgroundBase);
...
.page_ebook .codebox__output,
.page_ebook .codebox__output-line:before {
    color: var(--foregroundDefault)
}

.page_ebook .codebox__output-label {
    color: var(--foregroundAlt)
}
...
.working-hover .comments__header-title a:hover:before {
    color: var(--foregroundAccent)
}
...
.complex-form .complex-form__description {
    max-width: 650px;
...
.complex-form .complex-form__step-content {
    margin: 45px 80px
}

.complex-form .complex-form__step_current {
    display: block
}

.complex-form .complex-form__extract {
    box-sizing: border-box;
    margin: 0 auto 17px
}
...
.complex-form .complex-form__amount {
    width: 177px
}

.complex-form .complex-form__email {
    width: 290px;
    margin: 0 auto
}

.complex-form .complex-form__name {
    display: block;
    margin: auto;
    width: 290px
}

.complex-form .complex-form__email-note {
    font-size: 12px;
    color: #333;
    margin: 12px auto 0;
    line-height: 16px;
...
.complex-form .complex-form__pay-method {
...
.complex-form .complex-form__submit-line {
    margin: 50px 20px 30px
}

.complex-form .complex-form__currency-input .input-select {
    width: 70px;
    height: 38px;
    padding: 8px 4px;
    line-height: 20px;
...
@media (max-width: 840px) {
    ...
    .complex-form .complex-form__alternate-title:first-child:before {
        position: absolute;
        top: -15px;
        left: 50%;
        width: 35px;
...
.course-modal .modal__close:before {
    width: 38px;
    height: 38px;
    top: 8px;
    left: 8px
...
.working-hover .course-modal .modal__close:hover {
    opacity: .8
}
...
.courses-parts section.courses-part>.courses-part__title:before {
    counter-increment: a;
    content: counter(a);
    display: inline-block;
    border-radius: 50%;
...
.courses-part:last-child {
    margin-bottom: 0
}

.courses-part_vacation {
    border: 1px solid #e0e0e0;
    border-radius: 4px;
    padding: 24px;
    display: -webkit-flex;
...
.courses-part_vacation:before {
    display: none
}

.courses-part_vacation>.courses-part__title {
    margin-bottom: 0 !important
}

.courses-part>.courses-part__title,
.courses-part>h3 {
    font-size: 20px;
    line-height: 28px;
    margin-bottom: 16px;
...
.courses-part>.courses-part__text,
.courses-part>p {
    margin: 16px 0
}
...
.courses-part>.courses-part__text:last-child,
.courses-part>p:last-child {
    margin-bottom: 0
}
...
.extract__item_static {
    cursor: default
}

.extract__item_static .extract__wrap {
    padding-left: 24px
}

.extract__item_button .extract__wrap {
    -webkit-flex-wrap: wrap;
    -ms-flex-wrap: wrap;
    flex-wrap: wrap
}

.extract__item_button .extract__content {
    width: auto
}
...
@media (max-width: 568px) {
    ...
    .extract__item_static .extract__item__wrap {
        padding-left: 16px
    }
}
...
.working-hover .feedback-policy:hover .feedback-policy__popup {
    display: block;
    color: #333
}
...
.feedback-stat_profile .feedback-stat__list,
...
.feedback-stat_profile .feedback-stat__item,
...
.feedback-stat_profile .feedback-stat__item_clickable,
.feedback-stat_slider .feedback-stat__item_clickable {
    cursor: pointer
}

.feedback-stat_profile .feedback-stat__item_active .feedback-stat__text,
.feedback-stat_slider .feedback-stat__item_active .feedback-stat__text,
.working-hover .feedback-stat_profile .feedback-stat__item_clickable:hover .feedback-stat__text,
.working-hover .feedback-stat_slider .feedback-stat__item_clickable:hover .feedback-stat__text {
    color: #f8ab47
}

.feedback-stat_profile .feedback-stat__item_clickable .feedback-stat__amount,
.feedback-stat_slider .feedback-stat__item_clickable .feedback-stat__amount {
    color: #bf851c
}

.feedback-stat_profile .feedback-stat__status,
...
.feedback-stat_profile .feedback-stat__status-i,
.feedback-stat_slider .feedback-stat__status-i {
    background-color: #edad5a;
    border-radius: 2px
}

.feedback-stat_profile .feedback-stat__text,
.feedback-stat_slider .feedback-stat__text {
    width: 100%;
    text-align: left;
    color: #404040;
    margin-right: 10px
...
.feedback-stat_profile .feedback-stat__amount,
.feedback-stat_slider .feedback-stat__amount {
    color: #919191;
    margin-right: 12px;
    text-align: right
}

.feedback-stat_profile .feedback-stat__grade-info,
.feedback-stat_slider .feedback-stat__grade-info {
    width: 50%;
    padding-left: 17px;
    box-sizing: border-box
}

.feedback-stat_profile .feedback-stat__average-grade,
.feedback-stat_profile .feedback-stat__grade,
.feedback-stat_slider .feedback-stat__average-grade,
.feedback-stat_slider .feedback-stat__grade {
    margin-bottom: 10px
}

.feedback-stat_profile .feedback-stat__top-grade,
.feedback-stat_slider .feedback-stat__top-grade {
    font-size: 32px;
    line-height: 32px;
    font-weight: 500
}

.feedback-stat_profile .feedback-stat__delimeter,
.feedback-stat_profile .feedback-stat__max-grade,
.feedback-stat_slider .feedback-stat__delimeter,
.feedback-stat_slider .feedback-stat__max-grade {
    margin-left: 5px;
    color: #919191;
    font-size: 20px;
    line-height: 20px;
...
screen and (min-width:840px) and (max-width:940px) {
    .feedback-stat_profile .feedback-stat__list {
        width: 60%
    }
}
...
@font-face {
    ...
    font-weight: 400;
    font-style: normal;
    src: url(/pack/modules/styles/blocks/font/icons.b9ad9f78107447198d61a582feac1862.woff) format("woff"), url(/pack/modules/styles/blocks/font/icons.c17c7e4542b54991c2bad160b17a1354.otf) format("opentype")
}
...
.important_smart .important__type:before {
    color: var(--foregroundInformation)
}
...
.important_ok .important__type:before {
    color: var(--foregroundConstructiveAlt)
}
...
.lessons-list {
    margin: 11px 0 22px;
    border-radius: 6px;
    border: 4px solid var(--lessonsListBorder);
    background: var(--backgroundBase)
}
...
.lessons-list__section {
    width: 50%;
    border-right: 1px solid var(--lessonsListBorder);
    padding: 0 24px
}

.lessons-list__section:last-child {
    border-right: 0
}
...
.lessons-list__stat-line {
    margin-top: 6px
}

.lessons-list__repo-link {
    font-size: 14px;
    line-height: 20px
}

.lessons-list ol.lessons-list__lessons {
    list-style: none;
    padding: 0;
    margin: 0;
    counter-reset: c
...
.lessons-list__lesson[data-section-number]:before {
    content: attr(data-section-number) "." counter(c)
}
...
.lessons-list__lesson_level_2:first-child {
    border-top: 1px solid var(--lessonsListBorder)
}
...
.lessons-list__lesson_completed {
    padding-right: 50px
}

.lessons-list__lesson_completed:after {
    content: "";
    display: block;
    width: 13.35px;
    height: 14px;
    background: transparent url(/pack/modules/styles/blocks/lessons-list/checkmark.55272c9b238919af393a7b8fba67b328.svg) no-repeat 0 0;
...
.login-form_modal .login-form__form-control {
...
.login-form__warning {
    ...
    border-color: var(--yellow-11)
}

.login-form__info {
    background: var(--yellow-10);
    border-color: var(--yellow-12)
}

.login-form__success {
    background: var(--green-10);
    border-color: var(--green-12)
}
...
.login-form [data-form=register] .login-form__form-control {
    margin-right: 15px
}

.login-form [data-form=register] .login-form__form-control:last-child {
    margin-right: 0
}
...
.main_frontpage .comments {
    padding: 0 16px;
    max-width: 1304px
}

.main_frontpage .article-tablet-foot {
    padding: 0 16px
}
...
.main__header_center-desktop .main__header-title,
...
.main h2 .main__anchor:before,
.main h3 .main__anchor,
.main h3 .main__anchor:before,
.main h4 .main__anchor,
.main h4 .main__anchor:before {
    transition: unqufote("color") .2s
}

.working-hover .main h2 .main__anchor:hover,
.working-hover .main h2 .main__anchor:hover:before,
.working-hover .main h3 .main__anchor:hover,
.working-hover .main h3 .main__anchor:hover:before,
.working-hover .main h4 .main__anchor:hover,
.working-hover .main h4 .main__anchor:hover:before {
    color: #666
}
...
@media (max-width: 568px) {
    ...
    .main__header_jobs .main__header-title {
        font-size: 24px;
        line-height: 32px;
        color: #404040
    }
...
.mdeditor__resize-handle {
    background: url(/pack/modules/styles/blocks/mdeditor/resize-vertical.40ef55578ab83605376e0ecdb3e48aff.svg) 50% no-repeat;
    height: 11px;
    width: 26px;
    margin: auto;
    cursor: ns-resize
...
.mdeditor__button-separator {
    width: 20px;
    height: 20px;
    display: inline-block
}

.mdeditor__button_right {
    float: right
}
...
.mdeditor__button:focus {
    outline: none
}

.working-hover .mdeditor__button:hover {
    color: #000;
    cursor: pointer
}

.mdeditor__button[data-action=preview] {
    width: auto;
    margin-left: auto
}

.mdeditor__button[data-action=preview]:before {
    content: "\43F\440\435\434\43F\440\43E\441\43C\43E\442\440";
    vertical-align: middle;
    line-height: 20px;
    padding: 4px 6px;
    margin-right: 0
...
.mdeditor_preview .mdeditor__button[data-action=preview]:before {
    content: "\2715   \43F\440\435\434\43F\440\43E\441\43C\43E\442\440";
    border-radius: 20px;
    background: #dedede
}

.mdeditor__editor-row {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    -webkit-flex-direction: row;
...
.mdeditor_large .mdeditor__editor-row {
    height: 400px
}
...
.mdeditor__input:focus {
    outline: none
}

.mdeditor_preview .mdeditor__view {
    display: block;
    background: #fcfcfc;
    padding: 10px
}

.mdeditor_preview .mdeditor__input,
.mdeditor_preview .mdeditor__view {
    box-sizing: border-box;
    -webkit-flex: 0 1 50%;
    -ms-flex: 0 1 50%;
...
.mdeditor_preview-loading .spinner {
    left: -80px;
    position: absolute;
    top: 50%;
    display: block;
...
.mdeditor_preview-loading .spinner__dot {
...
.multiselect__dropdown-container {
    display: none;
    position: absolute;
    top: 50px;
    left: 0;
    ...
    border-radius: 4px;
    padding: 24px;
    box-shadow: 2px 2px 14px rgba(0, 0, 0, .09);
    z-index: 5;
    width: 100%;
    max-width: 650px;
    box-sizing: border-box
...
.multiselect_opened .multiselect__dropdown-container {
    display: block
}

.multiselect_opened .multiselect__active-button {
    border: 1px solid var(--borderPrimary)
}
...
.multiselect__dropdown {
    ...
    columns: 2;
    width: 100%;
    -webkit-column-width: calc(100% / 2 - 25px);
    column-width: calc(100% / 2 - 25px);
...
.multiselect__item_checked:before {
    border-image: none;
    border-color: var(--borderAction);
    background: var(--borderAction) url(/img/checkmark.svg) no-repeat 0 1px
}
...
.new-complex-form__alternate-title {
    font-size: 20px;
    line-height: 28px
}

.new-complex-form__alternate-title_error {
    color: #d1463d
}

.new-complex-form__alternate-title_success {
    color: #418458
}

.new-complex-form__error {
    margin-top: 0
}

.new-complex-form__info-text {
    margin-bottom: 24px
}

.new-complex-form__section {
    margin-bottom: 32px
}

.new-complex-form__section:last-child {
    margin-bottom: 0
}

.new-complex-form__section-header {
    margin-bottom: 16px
}

.new-complex-form__email {
    max-width: 315px;
    margin-bottom: 10px
}

.new-complex-form__amount {
    max-width: 240px;
    margin-bottom: 10px
}
...
.new-complex-form__submit {
    margin-bottom: 10px
}

.new-complex-form__submit-line {
    margin-top: 10px
}
...
.new-complex-form .new-complex-form__currency-input .input-select {
    width: 70px;
    height: 38px;
    padding: 8px 4px;
    line-height: 20px;
...
.notification_article .notification__content {
    margin: 15px;
...
.notification_ebook .notification__content {
    margin: 15px;
    font-size: 16px;
    line-height: 24px
}

.notification_ebook-order {
    margin: 0 0 10px
}

.notification_ebook-order .notification__content {
    margin: 15px;
    font-size: 16px;
    line-height: 24px
}
...
.working-hover #carbonads a:hover {
    text-decoration: none;
    color: #ba1000
}
...
.working-hover .carbon-img img:hover {
    opacity: 1
}
...
@media screen and (max-width: 1400px) {
    .page-wrapper_sidebar_on+.page-footer .page-footer__list {
        height: 60%;
        -webkit-flex-direction: column;
        -ms-flex-direction: column;
        flex-direction: column;
    ...
    .page-wrapper_sidebar_on+.page-footer .page-footer__item {
        margin-right: 25px
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item:after {
        display: none
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_contact {
        -webkit-order: 4;
        -ms-flex-order: 4;
        order: 4
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_terms {
        -webkit-order: 2;
        -ms-flex-order: 2;
        order: 2
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_privacy {
        -webkit-order: 1;
        -ms-flex-order: 1;
        order: 1
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_about {
        -webkit-order: 3;
        -ms-flex-order: 3;
        order: 3
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_slack {
        -webkit-order: 5;
        -ms-flex-order: 5;
        order: 5
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_source {
        -webkit-order: 6;
        -ms-flex-order: 6;
        order: 6
    }

    .page-wrapper_sidebar_on+.page-footer .page-footer__item_copy {
        -webkit-order: 0;
        -ms-flex-order: 0;
        order: 0;
        height: 100%
...
@media screen and (max-width: 1200px) {
    ...
    .page-footer .page-footer__item:after {
        display: none
    }

    .page-footer .page-footer__item_contact {
        -webkit-order: 4;
        -ms-flex-order: 4;
        order: 4
    }

    .page-footer .page-footer__item_terms {
        -webkit-order: 2;
        -ms-flex-order: 2;
        order: 2
    }

    .page-footer .page-footer__item_privacy {
        -webkit-order: 1;
        -ms-flex-order: 1;
        order: 1
    }

    .page-footer .page-footer__item_about {
        -webkit-order: 3;
        -ms-flex-order: 3;
        order: 3
    }

    .page-footer .page-footer__item_slack {
        -webkit-order: 5;
        -ms-flex-order: 5;
        order: 5
    }

    .page-footer .page-footer__item_source {
        -webkit-order: 6;
        -ms-flex-order: 6;
        order: 6
    }

    .page-footer .page-footer__item_copy {
        -webkit-order: 0;
        -ms-flex-order: 0;
        order: 0;
        height: 100%
...
.page-wrapper_donate,
.page-wrapper_ebook {
    background: transparent url(/pack/modules/styles/blocks/page-wrapper/ebook_bg.d0e79db126d43cfe5399902c8bcb9880.svg) no-repeat 0 0;
    background-size: 100% auto
}

.page-wrapper_profile-empty {
    background-image: url(/pack/modules/styles/blocks/page-wrapper/profile_bg.b2fcab271dcbc55adef1188121400f25.png);
    background-size: 400px
}

.page-wrapper_screencast {
    margin-bottom: -72px
}

.page-wrapper_screencast:after {
    height: 72px
}
...
.page_inner_padding .page__inner {
    margin: 0;
    padding: 0 120px
}
...
.page_ebook_epub .page__inner {
    padding: 0
}

.page_ebook_pdf .page__inner {
    padding: 0 40px
}
...
.page_ebook_epub .code-example pre[class*=language-]>code {
    font: 10px/14px Consolas, Lucida Console, Menlo, Monaco, monospace !important
}

.page_ebook_pdf .code-example code[class*=language-],
.page_ebook_pdf .code-example pre[class*=language-] {
    font: 14px/20px Consolas, Lucida Console, Menlo, Monaco, monospace !important
}
...
@media (max-width: 840px) {
    ...
    .page_sidebar_visible_mobile.page__sidebar {
        display: block
    }

    .page .page__sidebar.sidebar_profile {
        display: block;
        position: relative;
        top: auto;
        left: auto;
    ...
    .page_tablet-no-padding .page__inner {
        padding: 0
    }
...
.participant-application__input_invalid {
    border-color: var(--borderAccent);
    color: var(--foregroundAccent)
}
...
.participant-application__flex-line {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    -webkit-justify-content: flex-start;
...
.participant-application__flex-block {
    width: 100%
}

.participant-application__flex-block:first-child {
    margin-right: 20px
}
...
.pay-method__method-radio_height-auto:checked {
    margin-top: 0;
    top: 24px
}
...
.pay-method__method-radio:checked~.pay-method__method-label .payment-setting {
    display: block
}
...
.payment-currency-form__title {
    font: 700 28px/28px BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;
    white-space: nowrap
}
...
.payment-setting span:not(.payment-setting__item_hidden) {
    display: block;
    max-width: 100%
}
...
.payment-setting__list-item+.payment-setting__list-item {
    margin-top: 24px
}

.payment-setting__content {
    padding: 0 20px
}

.payment-setting__content-item+.payment-setting__content-item {
    margin-top: 12px
}
...
.payment-setting__cb_invoice-need[value=EDO]:checked~.payment-setting__item_hidden,
.payment-setting__cb_invoice-need[value=MAIL]:checked~.payment-setting__item_hidden,
.payment-setting__cb_invoice-need[value=SCAN]:checked~.payment-setting__item_hidden {
    display: block
}
...
.photo-cut__title {
    font: 700 28px/40px BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif
}
...
.token.comment,
.token.prolog {
    color: var(--prismTokenComment)
}

.language-html .language-css .token.punctuation,
.language-html .language-javascript .token.punctuation,
.token.punctuation {
    color: var(--prismTokenPunctuation)
}
...
.token.selector,
.token.string {
    color: var(--prismTokenSymbolsAlt)
}

.token.entity,
.token.operator {
    color: var(--prismTokenOperator)
}

.token.atrule {
    color: var(--prismTokenAtRule)
}
...
.token.keyword.module {
    color: var(--prismTokenKeywordControl)
}

.token.function,
.token.function .token.maybe-class-name {
    color: var(--prismTokenFunctionAndClassname)
}

.token.regex {
    color: var(--prismTokenRegex)
}

.token.class-name,
.token.maybe-class-name {
    color: var(--prismTokenClassname)
}
...
.token.parameter,
.token.property {
    color: var(--prismTokenInterpolation)
}

.token.constant {
    color: var(--prismTokenConstant)
}

.token.variable {
    color: var(--prismTokenVariable)
}
...
.token.keyword {
    color: var(--prismTokenKeyword)
}

.token.important,
.token.punctuation.interpolation-punctuation {
    color: var(--prismTokenImportant)
}
...
.token.tag .token.punctuation {
    color: var(--prismTokenCdata)
}

.token.attr-value,
.token.attr-value .token.punctuation {
    color: var(--prismTokenAttrvalue)
}
...
.main .inline-highlight {
    background: var(--backgroundPrismLineHighlight) !important
}
...
.page_ebook .block-highlight_inline {
    padding-left: 10px
}
...
code[class*=language-],
pre[class*=language-] {
    font: 15px/20px Consolas, Lucida Console, Menlo, Monaco, monospace;
    z-index: 0;
    text-shadow: none;
    margin: 0
}
...
@media (min-width: 1420px) {
    ...
    code[class*=language-],
    pre[class*=language-] {
        font: 16px/22px Consolas, Lucida Console, Menlo, Monaco, monospace
    }
}

code[class*=language-] code.token,
...
.profile__tab:not(.profile__tab_active) {
    display: none
}
...
.quote__text {
    font-style: italic;
    font-size: BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif "serif";
...
.rating_1 .rating__star:first-child,
.rating_2 .rating__star:first-child,
.rating_2 .rating__star:nth-child(2),
.rating_3 .rating__star:first-child,
.rating_3 .rating__star:nth-child(2),
.rating_3 .rating__star:nth-child(3),
.rating_4 .rating__star:first-child,
...
.receipts__receipt {
    position: relative;
    background: radial-gradient(7px at 0 0, #fff 0, #fff 7px, hsla(0, 0%, 100%, 0) 8px), radial-gradient(7px at 100% 0, #fff 0, #fff 7px, hsla(0, 0%, 100%, 0) 8px), radial-gradient(7px at 0 100%, #fff 0, #fff 7px, hsla(0, 0%, 100%, 0) 8px), radial-gradient(7px at 100% 100%, #fff 0, #fff 7px, hsla(0, 0%, 100%, 0) 8px), url(/pack/modules/styles/blocks/receipts/receipts__bg.413a20d949507701d49bfb20f506bb18.svg), #f9eebd;
    padding: 14px 61px 20px 23px
}

.receipts__receipt:first-child {
    border-radius: 10px 10px 0 0;
    background: radial-gradient(7px at 0 100%, #fff 0, #fff 7px, hsla(0, 0%, 100%, 0) 8px), radial-gradient(7px at 100% 100%, #fff 0, #fff 7px, hsla(0, 0%, 100%, 0) 8px), url(/pack/modules/styles/blocks/receipts/receipts__bg.413a20d949507701d49bfb20f506bb18.svg), #f9eebd
}
...
.receipts_register .receipts_register__receipt {
    padding: 15px 0 15px 25px
}

.receipts_register .course-register-info {
    display: block;
    width: auto;
    margin: 0;
    padding: 0;
...
.receipts_register .price {
    vertical-align: middle
}

.receipts_register .receipts_register__receipt-aside {
    white-space: nowrap;
    padding-right: 60px
}
...
.search-form__type[disabled] {
    border: 1px solid var(--borderPrimary);
    border-bottom-color: var(--backgroundBase);
    color: var(--foregroundAlt);
    border-radius: 3px 3px 0 0;
    cursor: default
}
...
.search-results__marked {
    color: inherit;
    background: var(--backgroundTextHighlight)
}
...
.share-icons .share:after {
    min-height: 30px
}

.share-icons .share_vk:after {
    margin-top: 5px
}
...
.sidebar_profile .sidebar__link {
    color: var(--foregroundDefault)
}

.sidebar_profile .sidebar__navigation-link_active {
    color: var(--foregroundAccent)
}

.sidebar_profile-empty {
    display: none
}
...
.sidebar__navigation-link+.sidebar__navigation-link {
    margin-top: 12px
}
...
.sidebar_compact #sponsorBarTitle {
    display: none
}
...
@media (max-width: 840px) {
    ...
    .sidebar_profile .sidebar__navigation-links {
        display: -webkit-flex;
        display: -ms-flexbox;
        display: flex;
        -webkit-flex-wrap: wrap;
    ...
    .sidebar_profile .sidebar__navigation-link {
        padding: 0 10px;
        margin: 0 0 5px
    }

    .sidebar_profile .sidebar__navigation-link:last-child {
        margin-right: 0
    }

    .sidebar_profile .sidebar__navigation {
        display: none
    }
}
...
.sitetoolbar-right-button_courses {
    font-weight: 500;
    color: var(--foregroundAccent);
    border: 2px solid var(--borderAccent)
}

.sitetoolbar-right-button_courses:active,
.sitetoolbar-right-button_courses:focus,
.working-hover .sitetoolbar-right-button_courses:hover {
    border-color: var(--borderAccentHover)
}

.sitetoolbar-right-button_book {
    color: var(--foregroundDefault);
    border: 2px solid var(--borderPrimary)
}

.sitetoolbar-right-button__extra-text {
    margin-right: 3px
}
...
.sitetoolbar__logo_normal.sitetoolbar__logo_dark,
.sitetoolbar__logo_small.sitetoolbar__logo_dark,
html[data-theme=dark] .sitetoolbar__logo_normal,
html[data-theme=dark] .sitetoolbar__logo_small.sitetoolbar__logo_dark {
    display: none
}

html[data-theme=dark] .sitetoolbar__logo_normal.sitetoolbar__logo_dark {
    display: inline
}
...
.sitetoolbar_page-main .sitetoolbar__lang-switcher {
    border-color: transparent
}

.sitetoolbar__lang-switcher .sitetoolbar__dropdown-button {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.sitetoolbar_page-main .sitetoolbar__lang-switcher .sitetoolbar__dropdown-button {
    color: var(--white)
}
...
.sitetoolbar__lang-switcher .sitetoolbar__dropdown-button:after {
    content: none
}

.sitetoolbar_page-main .sitetoolbar__lang-switcher .sitetoolbar__dropdown-button:active,
.working-hover .sitetoolbar_page-main .sitetoolbar__lang-switcher .sitetoolbar__dropdown-button:hover {
    color: var(--redBrand-30)
}
...
html[dir=rtl] .sitetoolbar__lang-switcher .sitetoolbar__dropdown-body {
    right: -15px;
    left: auto
}
...
html[dir=rtl] .sitetoolbar__lang-switcher .sitetoolbar__dropdown-body:before {
    left: auto;
    right: 21px
}

.sitetoolbar__lang-switcher-body {
    padding: 24px
}
...
.working-hover .sitetoolbar__section_current .sitetoolbar__dropdown-button:hover,
.working-hover .sitetoolbar__section_current .sitetoolbar__dropdown-button:hover:hover,
.working-hover .sitetoolbar__section_current .sitetoolbar__link:hover,
.working-hover .sitetoolbar__section_current:hover {
    color: var(--foregroundAccentHover)
}
...
.sitetoolbar__search-input {
    ...
    overflow: hidden;
    opacity: 0;
    transition: left .3s ease-out .1s, opacity .4s ease-out
}
...
.sitetoolbar__find {
    ...
    padding: 0;
    border: none;
    border-left: 1px solid var(--borderAction);
...
.sitetoolbar_search_open .sitetoolbar__right-button-wrap,
...
.sitetoolbar__lang-switcher-item_current .sitetoolbar__secondary-link {
    color: var(--foregroundAccent)
}
...
@media (max-width: 1175px) {
    ...
    .sitetoolbar__right-button-wrap .sitetoolbar-right-button {
        font-size: 14px
    }
...
@media screen and (max-width: 900px) {
    ...
    .sitetoolbar_page-main .sitetoolbar__nav-toggle {
        color: var(--white)
    }

    .sitetoolbar__nav-toggle_active {
        color: var(--foregroundSubtle) !important
    }
...
@media (max-width: 568px) {
    ...
    .sitetoolbar__right-button-wrap .sitetoolbar-right-button__extra-text {
        display: none
    }

    .sitetoolbar__right-button-wrap .sitetoolbar-right-button__text {
...
.working-hover .slider__arrow:hover {
    color: #333
}
...
.slider_disable-left .slider__arrow_left,
.slider_disable-left .slider__container:before,
.slider_disable-right .slider__arrow_right,
.slider_disable-right .slider__container:after,
.slider_disabled .slider__arrow_left,
.slider_disabled .slider__arrow_right,
.slider_disabled .slider__container:after,
.slider_disabled .slider__container:before {
    display: none
}

.slider_frontpage .slider__container:before {
    background: linear-gradient(90deg, #fbf3e5 0, hsla(0, 0%, 100%, 0))
}

.slider_frontpage .slider__container:after {
    background: linear-gradient(270deg, #fbf3e5 0, hsla(0, 0%, 100%, 0))
}

.slider_vacancies .slider__container:before {
    background: linear-gradient(90deg, #fcf1d6 0, hsla(0, 0%, 100%, 0))
}

.slider_vacancies .slider__container:after {
    background: linear-gradient(270deg, #fcf1d6 0, hsla(0, 0%, 100%, 0))
}
...
@media (-moz-touch-enabled:1) and (max-width: 1020px),
(pointer:coarse) and (max-width:1020px) {
    .slider {
        padding: 0
    }
...
.subscribe__toggle-link:visited {
    color: #0059b2
}
...
.subscribe__email-input .text-input-button__input {
    padding-right: 8px
}

.subscribe__greyed-text {
    font-size: 16px;
    line-height: 24px
}

.subscribe__greyed-text_small {
    margin-top: 16px;
    color: #919191;
    font-size: 14px;
    line-height: 20px
...
.subscribe_opened .subscribe__form {
    margin-top: 24px
}
...
.summary-cost__info:not(:empty) {
    margin: 8px 0 0 !important
}

.buy-discount__discount-label {
...
.buy-discount__discount-options {
    display: none;
    margin-bottom: 12px
}

.buy-discount__discount-button {
    margin-left: 16px
}

.buy-discount [data-elem=discount-remove] {
    display: none
}

.buy-discount .button_action.button_loading {
    background-color: #67b689
}

.buy-discount_applied [data-elem=discount-remove] {
    display: inline
}

.buy-discount_applied [data-elem=discount-apply] {
    display: none
}

.text-input.text-input_discount {
    width: 250px;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.text-input.text-input_discount input:disabled {
    color: inherit
}

.buy-discount_open .buy-discount__discount-options {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex
}

.buy-discount_applied .text-input.text-input_discount input {
    background-color: var(--borderConstructive);
    border-color: var(--backgroundConstructive)
}

.buy-discount_applied .text-input.text-input_discount:after {
    display: inline
}
...
.tabbed-pane .tabbed-pane__tab-title {
    border-bottom: 2px solid #9b6b6b;
    margin-bottom: 20px
}

.tabbed-pane .tabbed-pane__tab-title span {
    display: inline-block;
    padding: 2px 16px;
    font-size: 12px;
    font-weight: 500;
...
.tablet-menu-search__button {
    border: none;
    background-color: var(--backgroundConstructiveAlt);
    border-radius: 0 4px 4px 0;
    padding: 0;
    height: 40px;
    position: relative;
...
.working-hover .tablet-menu-search__button:hover {
    background-color: var(--backgroundConstructive)
}
...
.main tr.teacher-info__line:nth-child(2n) {
    background: none
}
...
.tutorial-progress[value]::-webkit-progress-value {
    background: var(--backgroundProgressBarValue)
}
...
.button_danger:visited {
    background: linear-gradient(180deg, #d45f5f, #be4848);
    color: #fff
}

.working-hover .button_danger:hover {
    color: #fff;
    background: linear-gradient(180deg, #f07274, #de3d44)
}

.button_danger:focus {
    background: linear-gradient(180deg, #d45f5f .59%, #be4848);
    border: 1px solid #d9b915;
    box-sizing: border-box;
    box-shadow: inset 0 3px 4px rgba(171, 161, 0, .123);
    border-radius: 3px;
    outline: none
}
...
.button_danger:focus:active {
    background: linear-gradient(180deg, #f07274 .59%, #de3d44);
...
.button_action.button_outline {
    background-color: transparent;
    color: #51a06c;
    border: 1px solid #51a06c
}

.button_action.button_outline:active,
.button_action.button_outline:focus,
.button_action.button_outline:focus:active,
.working-hover .button_action.button_outline:hover {
    color: #fff;
    border-color: #67b689;
    background: #67b689
}
...
.button_light.button_outline:active,
.button_light.button_outline:focus,
.working-hover .button_light.button_outline:hover {
    opacity: .8
}

.button_light.button_outline.button_small {
    font: 400 14px/22px BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;
    padding: 0 8px;
    height: 26px
}

.button_big {
    font: 700 16px/24px Open Sans, sans;
    line-height: 24px;
    padding: 8px 16px
}
...
@media (max-width: 840px) {
    ...
    .checkbox-input_with-input .checkbox-input__label {
        margin-bottom: 10px
    }

    .checkbox-input_with-input .checkbox-input__hidden {
        margin-left: 23px
    }
}

.checkbox-input__last-child {
    margin-bottom: 0
}
...
.checkbox-input__control:checked+.checkbox-input__label:before {
    border-image: none;
    border-color: #3494f9;
    background: #3494f9 url(/img/checkmark.svg) no-repeat 0 1px
}

.checkbox-input__control:checked+.checkbox-input__label+.checkbox-input__hidden {
    display: block
}

.checkbox-input__hidden {
    display: none;
    margin-left: 30px
}
...
.courses-header_vacancies {
    background-color: #403f3a
}

.courses-header_vacancies .courses-header__back {
    display: inline-block;
    border-bottom: 1px solid transparent;
    margin-bottom: 30px
}

.courses-header_vacancies .courses-header__title {
    font-size: 24px;
    line-height: 32px
}

.courses-header_vacancies .courses-header__inner {
    padding: 0;
    color: #fff;
    background-image: url(/pack/templates/blocks/courses-header/background.b634d17122875cb0ab395988176d007a.png);
    background-position: 100%;
    background-size: contain;
    background-repeat: no-repeat
}

.courses-header_vacancies .courses-header__text {
    margin-bottom: 28px
}

.courses-header_vacancies .courses-header__content {
...
.courses-header_vacancies .courses-header__content:after {
    content: "";
    display: block;
    position: absolute;
    right: -140px;
    ...
    width: 140px;
    height: 100%;
    background: transparent url(/pack/templates/blocks/courses-header/tr.fbd590d8cd2a1370e8ebf3d68478bc09.svg) no-repeat 0 0;
...
.courses-header_frontpage .courses-header__inner {
    margin: 0 auto;
    max-width: 940px;
    padding-right: 0
}

.courses-header_course-order {
...
.courses-header__content p {
    margin: 0 0 16px
}

.courses-header_frontpage .courses-header__content {
    width: 100%
}

.courses-header__aside {
    min-width: 336px;
    position: relative;
    background-color: #fff;
    overflow: hidden;
...
.courses-header__aside-content {
    position: relative;
    z-index: 2;
    padding-right: 120px
}

.courses-header__image-container {
    width: 120px;
    height: 100px;
    padding: 0 10px;
    position: absolute;
...
.courses-header__image {
    width: 100%;
    position: relative;
    z-index: 1
}

.courses-header__button_vacancies {
    padding: 12px 30px 13px 10px;
    color: #f7d075;
    background: transparent;
    border: 1px solid #f7d075;
    border-radius: 3px;
    font-size: 16px;
    line-height: 24px;
    font-weight: 500
...
.courses-header__button_vacancies:focus,
.working-hover .courses-header__button_vacancies:hover {
    color: #f7d075;
    text-decoration: none
}

.courses-header__button_vacancies:before {
    content: "";
    display: inline-block;
    vertical-align: middle;
    margin-right: 15px;
    width: 18px;
    height: 24px;
    background-image: url(/pack/templates/blocks/courses-header/arrow-without-circle.c008b2f712ab98151694abd0035b2365.svg);
    background-size: cover
}
...
.working-hover .courses-header__back:hover {
    border-bottom: 1px solid rgba(186, 16, 0, .3);
    text-decoration: none
}

.courses-header__back:before {
    content: "\2190   ";
    position: absolute;
    left: -20px
}
...
.courses-list_vacancies .courses-list__inner {
    max-width: 1200px
}

.courses-list_vacancies .courses-list__title {
    margin-bottom: 32px
}
...
.courses-list__item-opened {
    background: transparent url(/frontpage/is-listed.svg) no-repeat 0 0;
    background-size: cover;
    font-size: 9px;
    line-height: 11px;
    padding-top: 5px
...
.courses-list__item-new {
    background: transparent url(/frontpage/is-new-course.svg) no-repeat 0 0;
    background-size: cover;
    font-size: 12px;
    line-height: 12px;
    padding-top: 14px;
...
.courses-list__item-link:visited {
    color: #333
}
...
@media (-moz-touch-enabled:1) and (max-width: 1020px),
(pointer:coarse) and (max-width:1020px) {
    .courses-list__item:first-child {
        margin-left: 20px
    }
...
.courses-slider_vacancies .courses-slider__inner {
    max-width: 1200px
}

.courses-slider_vacancies .courses-slider__title {
    margin-bottom: 32px
}
...
.courses-slider__slider:not(.slider_disabled) {
    margin: 0 -50px
}
...
.courses-slider__item:not(:last-child) {
    margin-right: 20px
}

.courses-slider__item-opened {
    background: transparent url(/frontpage/is-listed.svg) no-repeat 0 0;
    background-size: cover;
    font-size: 9px;
    line-height: 11px;
...
.courses-slider__item-link:visited {
    color: #333
}

.courses-slider__item-image {
    background: #fff;
    border-radius: 4px;
    width: 140px;
    height: 140px;
...
.courses-slider__item-image img {
    margin: 0 auto;
    width: 100%;
    height: auto
}
...
(pointer:coarse) and (max-width:1020px) {
    ...
    .courses-slider__slider.slider_disabled,
    .courses-slider__slider:not(.slider_disabled) {
        margin: 0 -16px
    }

    .courses-slider__item:first-child {
        margin-left: 20px
    }
...
.price {
    font: 24px/1 BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    -webkit-flex-direction: column;
...
.radio-input__control:checked+.radio-input__label:before {
    background: linear-gradient(180deg, #3f9af9, #3f9af9);
    border-color: #3f9af9
}

.radio-input__control:checked+.radio-input__label:after {
    content: "";
    position: absolute;
    top: 9px;
    left: 5px;
...
.supported-langs__text {
    white-space: normal;
    margin-bottom: 24px;
    color: var(--foregroundDefault)
}

.supported-langs__info {
    white-space: normal;
    margin-top: 24px;
    color: var(--foregroundSubtle)
}

.supported-langs__container {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.supported-langs__list {
    padding: 0 24px;
    width: 205px;
    max-height: 300px
}

.supported-langs__list:not(:first-child) {
    border-left: 1px solid var(--borderPrimary)
}

.supported-langs__item:not(:last-child) {
    margin-bottom: 16px
}

.supported-langs__link {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    -webkit-align-items: flex-start;
...
.working-hover .supported-langs__link:hover {
    text-decoration: none
}

.working-hover .supported-langs__link[href]:hover .supported-langs__brief {
    color: var(--foregroundAccent)
}

.working-hover .supported-langs__link:not([href]):hover {
    color: var(--foregroundDefault)
}

.supported-langs__item_current .supported-langs__brief,
.supported-langs__item_current .supported-langs__link,
.working-hover .supported-langs__item_current .supported-langs__link:hover {
    color: var(--foregroundAccent)
}

.supported-langs__brief {
    color: var(--foregroundSubtle);
    margin-right: 12px;
    position: absolute;
    left: 0;
...
.supported-langs_about .supported-langs__text {
    font-size: 16px;
    line-height: 24px;
    margin-bottom: 30px
}
...
.supported-langs_about .supported-langs__info {
    margin-top: 44px
}

.supported-langs_about .supported-langs__container {
    margin: 0
}

.supported-langs_about .supported-langs__list {
    padding: 0;
    width: auto;
    ...
    column-fill: auto;
    -webkit-column-rule: 1px solid var(--borderPrimary);
    column-rule: 1px solid var(--borderPrimary);
...
html[data-theme=dark] .text-input__control {
    box-shadow: none
}
...
.text-input_big .text-input__control {
    height: 44px;
    padding: 4px 14px
}

.text-input_simple .text-input__control {
    height: 36px;
    box-shadow: none;
    padding: 8px 12px
}

.text-input_simple .text-input__control:disabled {
    background: #f7f7f7;
    border-color: #e7e7e7
}

.text-input_plain .text-input__control {
    box-shadow: none;
    border-color: transparent;
    border-radius: 4px
}
...
.theme-changer_tablet-menu {
    margin-left: -10px
}

.working-hover .theme-changer_tablet-menu:hover {
    background: initial
}

@media (max-width: 900px) {
    .theme-changer_hidden-sm {
        display: none
    }
}

.theme-changer_has-label {
    width: auto;
    margin-left: 0
}

.theme-changer_has-label,
.theme-changer_has-label .theme-changer__label {
    display: -webkit-inline-flex;
    display: -ms-inline-flexbox;
    display: inline-flex
}
...
.theme-changer__icon_dark-theme:before {
    content: "\E85C";
    font-family: FontIcons;
    -webkit-font-smoothing: antialiased
}

.theme-changer__icon_light-theme:before {
    content: "\E85D";
    font-family: FontIcons;
    -webkit-font-smoothing: antialiased
}
...
.theme-changer__input:not(:checked)~.theme-changer__icon_dark-theme,
.theme-changer__input:not(:checked)~.theme-changer__label-text_dark-theme {
    display: block
}

.theme-changer__input:checked~.theme-changer__icon_dark-theme,
.theme-changer__input:checked~.theme-changer__label-text_dark-theme,
.theme-changer__input:not(:checked)~.theme-changer__icon_light-theme,
.theme-changer__input:not(:checked)~.theme-changer__label-text_light-theme {
    display: none
}

.theme-changer__input:checked~.theme-changer__icon_light-theme,
.theme-changer__input:checked~.theme-changer__label-text_light-theme {
    display: block
}
...
.main__header-inner .main__header-group {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    -webkit-flex-direction: row;
...
.social-login_discord {
    background: #7288da
}

.working-hover .social-login_discord:hover {
    background: #3453c5
}
...
.social-login_google:before {
    ...
    width: 26px;
    height: 30px;
    background: url(/img/btn_google_light_normal_ios.svg) 50% no-repeat;
    vertical-align: top
}
...
.screencast-header__title {
    font-size: 60px;
    font-weight: 400
}

.screencast-header__title-accent {
    font-weight: 700
}

.screencast-header__description {
    font-size: 20px
}

.screencast-header__buttons {
    margin-top: 10px
}

.screencast-header__button {
    display: inline-block;
    margin: 20px 10px 0
}

.screencast-header__button .simple-button {
    min-width: 220px
}

.screencast-header .donate-links__title,
.screencast-header .share-icons__title,
.screencast-header__info {
    font-size: 12px
}
...
.screencast-header .share-icons .share {
    transition: color .2s
}

.screencast-header .donate-links,
.screencast-header .share-icons {
    display: inline-block;
    margin-right: 10px
}

.screencast-header__foot {
    font-size: 17px;
    margin-top: 30px
}

.screencast-header:after {
    position: absolute;
    width: 31px;
    height: 31px;
    margin-left: -15px;
...
.quiz-percents__result .quiz-percents__percents {
    font-size: 48px;
    font-weight: 700;
    line-height: normal
}

.quiz-percents__position {
    margin-top: 10px
}

.quiz-percents__position .quiz-percents__percents {
    font-size: 32px;
    font-weight: 700;
    line-height: normal
}
...
.quiz-question__description .code-example,
.quiz-question__description .codebox {
    margin: 0
}
...
@media (max-width: 568px) {
    ...
    .quiz-question__body .code-example {
        margin: 0 -20px
    }

    .quiz-question_correct_false,
    .quiz-question_correct_true {
        margin: 15px -10px 0
    }

    .quiz-question_correct_false:last-child,
    .quiz-question_correct_true:last-child {
        margin-bottom: 30px
    }
...
.main .quiz-result li:before {
    display: none
}

.quiz-result__retry-form,
.quiz-result__save-form {
    display: inline-block
}
...
.quiz-result__retry-button,
.quiz-result__save-button {
    min-width: 215px
}
...
.quiz-result .quiz-percents,
.quiz-result .quiz-weak-list__title {
    color: #7a7a7a
}

.quiz-result .quiz-percents__percents,
.quiz-result .quiz-results-indicator,
...
@media (max-width: 840px) {
    ...
    .quiz-result__center,
    .quiz-result__right {
        border-top: 2px solid hsla(180, 1%, 84%, .15)
    }
}
...
.quiz-results-indicator__indicator {
    position: relative;
    display: inline-block;
    width: 203px;
    height: 102px;
    background: no-repeat url(/pack/modules/quiz/client/styles/quiz-results-indicator/chart.2ae19b183bdfa0bcaecc462b607fc969.svg)
}
...
.quiz-results-indicator__text {
    display: inline-block;
    margin-top: 10px
}

.quiz-results-indicator__level {
    font-weight: 700
}

.quiz-results-indicator__level_junior {
    color: #ffc800
}

.quiz-results-indicator__level_medium {
    color: #ff7b00
}

.quiz-results-indicator__level_senior {
    color: #c20800
}
...
.main .quiz-results-table__empty-message {
    margin: 12px;
    padding: 10px
}

.main .quiz-results-table__results,
.main .quiz-results-table__results dd,
.main .quiz-results-table__results dl,
.main .quiz-results-table__results dt,
.main .quiz-results-table__results h1,
.main .quiz-results-table__results li,
.main .quiz-results-table__results p,
.main .quiz-results-table__results td,
.main .quiz-results-table__results th,
.main .quiz-results-table__results ul {
    font-size: inherit;
    font-weight: 400;
    margin: 0;
    padding: 0
...
.main .quiz-results-table__results .quiz-results-table__result:nth-child(2n) {
    background: none
}

.quiz-results-table__results {
    width: 100%;
    white-space: nowrap
}

.main .quiz-results-table__results tr:first-child th {
    vertical-align: top;
    border-bottom-width: 1px
}

.main .quiz-results-table__results .quiz-results-table__result:last-child,
.main .quiz-results-table__results .quiz-results-table__result:last-child th {
    border: none
}
...
.main .quiz-results-table__results .quiz-results-table__time,
.main .quiz-results-table__results .quiz-results-table__title,
.main .quiz-results-table__results .quiz-results-table__title-head,
.main .quiz-results-table__results .quiz-results-table__try {
    font-size: 12px;
    line-height: 12px;
    display: block;
    margin-bottom: 7px;
...
.main .quiz-results-table__results .quiz-results-table__name {
...
.quiz-results-table__precents {
    text-align: center
}

.main .quiz-results-table__results .quiz-results-table__precents-value {
    font-size: 28px;
    line-height: 28px;
    color: #4c906b
}

.main .quiz-results-table__results .quiz-results-table__level-info,
.main .quiz-results-table__results .quiz-results-table__time-spent-info {
    font-size: 14px;
    line-height: 14px
}
...
.quiz-selector ul li:before {
    display: none
}

.quiz-selector .quiz-selector__item {
    font-size: 13px;
    padding: 25px 30px;
    white-space: nowrap;
...
.quiz-selector .quiz-selector__item:last-child {
    border: none
}

.quiz-selector__start,
.quiz-selector__text {
    display: inline-block;
    box-sizing: border-box;
    vertical-align: middle
...
.quiz-selector__start-i {
    position: relative;
    display: inline-block
}

.quiz-selector .quiz-selector__title {
    font-family: BlinkMacSystemFont, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif;
    font-size: 18px;
    margin-bottom: 10px;
    color: #b20000
...
.quiz-start .button_action {
    font-size: 18px;
    line-height: 47px;
    padding: 1px 40px
}

.quiz-start .button_action:active,
.quiz-start .button_action:focus {
    padding: 0 39px
}

.quiz-tablet-timeline .quiz-tablet-timeline__title {
    margin: 0
}

.quiz-tablet-timeline__num {
    color: #f8ab47
}

.quiz-tablet-timeline__total {
    color: #a9a9a9
}
...
.quiz-timeline__number_current {
    border-radius: 10px;
    color: #fff;
    background: #f8ab47
}

.quiz-timeline__number_current~.quiz-timeline__number {
    color: #333
}
...
.quiz-weak-list__title {
    font-size: 14px;
    font-weight: 400
}

.quiz-weak-list__list {
    display: inline-block;
...
.newsletter-release-edit__err {
    color: red
}

.newsletter-release-edit__form {
    display: inline-block;
    width: 100%;
    min-width: 350px;
    padding: 25px 25px 35px;
...
.newsletter-release-edit .input-select,
.newsletter-release-edit .text-input {
    width: 80%
}

.newsletter-release-edit__line {
    margin-top: 25px
}

.newsletter-release-edit__line:first-child {
    margin-top: 0
}

.newsletter-release-edit__line:last-child {
    margin-top: 30px
}

.newsletter-release-edit__label {
    display: block;
    color: #666
}

.newsletter-release-edit__note {
    font-size: 12px;
    color: #333;
    margin: 12px auto 0;
    line-height: 16px;
...
.newsletter-template-form__err {
    color: red
}

.newsletter-template-form__form {
    width: 100%;
    display: inline-block;
    min-width: 350px;
    padding: 25px 25px 35px;
...
.newsletter-template-form .input-select,
.newsletter-template-form .text-input {
    width: 100%
}

.newsletter-template-form__line {
    margin-top: 25px
}

.newsletter-template-form__line:first-child {
    margin-top: 0
}

.newsletter-template-form__line:last-child {
    margin-top: 30px
}

.newsletter-template-form__label {
    display: block;
    color: #666
}

.newsletter-template-form__note {
    font-size: 12px;
    color: #333;
    margin: 12px auto 0;
    line-height: 16px;
...
.newsletter-failed__label {
    text-align: left;
    margin-bottom: 10px
}

.newsletter-release-edit {
    border: 4px solid #f2e7b3;
    border-radius: 10px;
    padding: 40px 50px;
    margin: 0 auto;
...
.newsletter-release-edit__group {
    margin-top: 10px;
    width: 100%;
    display: -webkit-flex;
    display: -ms-flexbox;
...
.newsletter-release-edit__group:first-of-type {
    margin-bottom: 10px
}
...
.newsletter-release-edit__group+.newsletter-release-edit__link {
    text-align: left
}

.newsletter-release-edit__field {
    margin-bottom: 20px
}

.newsletter-release-edit__button {
    margin-right: 10px;
    display: inline-block;
    vertical-align: middle
}
...
.newsletter-release-edit__delete {
    margin-left: 20px;
    color: #b80000
}
...
.newsletter-release-edit__remove {
    width: auto;
    color: #000;
    transition: #333 .3s ease;
    margin-left: 10px;
    margin-right: 10px;
    margin-bottom: 10px;
    width: 13px
...
.working-hover .newsletter-release-edit__remove:hover {
    text-decoration: none;
    color: #333
}

.newsletter-release-edit__select {
...
.newsletter-release-edit__select_middle {
    width: auto;
    -webkit-flex-grow: 3;
    -ms-flex-positive: 3;
    flex-grow: 3;
...
.newsletter-release-edit__select_small {
    margin-right: 10px;
    margin-bottom: 10px;
    width: auto;
    -webkit-flex-grow: 1;
...
.newsletter-release-edit__link {
    font-size: 14px
}

.newsletter-release-edit__button-preview {
    -webkit-appearance: none;
    -moz-appearance: none;
    appearance: none;
    background: none;
...
.working-hover .newsletter-release-edit__button-preview:hover {
    cursor: pointer
}
...
.newsletter-release-edit__preview,
.newsletter-release-edit__textarea {
    margin-bottom: 30px
}

.newsletter-release-edit__preview-link {
    color: #696664;
    font-size: 14px;
    margin-bottom: 15px;
    cursor: pointer;
...
.newsletter-release-edit__preview-content {
    font-size: 14px;
    line-height: 19px;
...
.newsletter-release-edit__preview-content p {
    margin-top: 0
}

.newsletter-release-edit__preview-content p:last-child {
    margin-bottom: 0
}

.newsletter-release-edit__preview_active .newsletter-release-edit__preview-link:after {
    -webkit-transform: rotate(0deg);
    transform: rotate(0deg)
}

.newsletter-release-edit__preview_active .newsletter-release-edit__preview-content {
    height: auto;
    padding-top: 15px;
    padding-bottom: 15px;
    border-bottom: 1px solid #eee
...
.newsletter-release-form__section {
    margin-bottom: 30px
}
...
.newsletter-status__highlighted {
    color: #469269;
    font-weight: 700
}

.newsletter-status__fields {
    margin-top: 35px
}

.newsletter-status__select {
    margin: 0 15px;
    display: inline-block
}
...
.newsletter-status__label {
    font-size: 13px;
    line-height: 17px;
    color: #999
}

.newsletter-status__button {
    margin-top: 33px;
    margin-bottom: 18px
}

.newsletter-status__button-text {
    font-weight: 700;
    color: #b80000
}
...
.newsletter-template__field {
    margin-bottom: 20px
}

.newsletter-template__label {
    font-size: 14px;
    margin-bottom: 10px;
    display: block
}

.newsletter-template__textarea {
    font-size: 14px;
    line-height: 19px
}

.newsletter-template__controls {
    margin-top: 25px;
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.newsletter-template__cancel {
    margin-left: 25px
}

.newsletter-template__remove {
    margin-left: auto;
    color: #999
}

.newsletter-template .input-select {
    width: 100%;
    padding-bottom: 8px
}

.newsletter-template .dynamic {
    display: none
}

.newsletter-template .dynamic.visible {
    display: block
}

.newsletter-template__description {
    font-size: 12px;
    line-height: 1;
    background: #eee;
    padding: 8px 10px
...
.newsletter-template__description p {
    margin: 0 0 6px
}
...
.courses-certificate__description {
    margin: 0;
    line-height: 1.6
}
...
.course-feedback__username-plain {
    font-weight: 700;
    color: #404040
}
...
.course-feedback__homepage-link {
    display: block;
    overflow-wrap: break-word;
...
.course-feedback__info:first-letter {
    text-transform: capitalize
}
...
@media (max-width: 840px) {
    ...
    .course-feedback:not(.course-feedback_form) .course-feedback__user {
        padding-right: 60px
    }

    .course-feedback:not(.course-feedback_form) .course-feedback__userpic {
        top: 0
    }
...
@media (max-width: 568px) {
    ...
    .course-feedback:not(.course-feedback_form) .course-feedback__userpic-img {
        width: 64px;
        height: 64px
    }

    .course-feedback:not(.course-feedback_form) .course-feedback__homepage {
        padding-right: 0
    }
...
.course-feedbacks_loading .course-feedbacks__feedbacks-list,
.course-feedbacks_loading .course-feedbacks__head {
    position: relative;
    opacity: .5;
    pointer-events: none;
    z-index: 2
...
.course-feedbacks_no-feedback .course-feedbacks__feedbacks-list {
    text-align: center
}

.course-feedbacks_profile.course-feedbacks_no-feedback .course-feedbacks__feedbacks-list {
    text-align: left
}
...
.course-list-item {
    background: var(--backgroundElevated1);
...
.course-list-item:focus,
.working-hover .course-list-item:hover {
    box-shadow: 0 10px 13px rgba(0, 0, 0, .1);
    background: var(--backgroundElevated2);
    text-decoration: none;
    color: initial
}

.course-list-item__info-header {
    margin-bottom: 16px
}
...
.course-list-item__question-list li:before {
    content: "\2022";
    padding-right: 10px;
    padding-left: 10px;
    font-size: 18px;
...
.course-list-item_big .course-list-item__title {
    margin-bottom: 16px
}

@media (max-width: 568px) {

    .course-list-item_big .course-list-item__description,
    .course-list-item_big .course-list-item__title {
        padding-right: 0
    }
}

.course-list-item_big .course-list-item__icon {
    max-width: 84px;
    width: 100%;
    max-height: 84px;
...
@media (max-width: 568px) {
    .course-list-item_big .course-list-item__content {
        padding-right: 92px
    }
}
...
.course-list-item__content p+p {
    margin-top: 8px
}

.course-list-item__content-bar {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
    -webkit-flex-direction: row;
...
.course-list-item__content-bar>:last-child {
    margin-right: 0
}
...
.course-list-item__badge_masterclass {
    color: var(--foregroundAccent)
}
...
.course-list-item__title_no-margin {
    margin-bottom: 0
}
...
.course-list-item__link:active,
.course-list-item__link:focus,
.working-hover .course-list-item__link:hover {
    color: #fff;
    text-decoration: none;
    opacity: .8
}

.course-list-item__link:after {
    content: "\E807";
    font-family: FontIcons;
    -webkit-font-smoothing: antialiased;
    font-size: 24px;
...
.course-list-item__link_outline {
    background-color: #fff;
    color: #51a06c
}

.course-list-item__link_outline:active,
.course-list-item__link_outline:after,
.course-list-item__link_outline:focus,
.working-hover .course-list-item__link_outline:hover {
    color: #51a06c
}
...
.courses-grid.courses-grid_3-col {
...
.courses-grid.courses-grid_2-col {
...
.courses-grid_bottom-gap {
    margin-bottom: 40px
}

.courses-grid_bottom-gap-sm {
    margin-bottom: 24px
}
...
.working-hover .task-actions .button:disabled::hover {
    background: #fff f
}
...
.tutorial-map-overlay .tutorial-map:after {
    ...
    right: 0;
    height: 45px;
    background: var(--gradientFadeOut);
    content: ""
}
...
.tutorial-map-list-three__link:visited {
    color: var(--foregroundSubtle)
}
...
.tutorial-map_show-tasks .tutorial-map-list-four:not(:empty) {
    display: block
}
